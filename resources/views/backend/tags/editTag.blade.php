...
@section('content')
    <form style="margin: 30px" method="post" action="/admin/tag/{{$tag->id }}/update" >
    ...
    <a class="btn btn-primary" style="margin: 0px 30px; font-size: 18px" href="//fuckenhomework.test/listTags">Отменить</a>
    </form>
@endsection
