...
@section('content')
    <form style="margin: 30px" method="post" action="/admin/category/{{$category->id }}/update" >
    ...
    <a class="btn btn-primary" style="margin: 0px 30px; font-size: 18px" href="//fuckenhomework.test/listCategory">Отменить</a>
    </form>
